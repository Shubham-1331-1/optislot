...
class Elective(models.Model):
    ...
    @property
    def status(self):
        """Returns color status: green/yellow/red."""
...
class Choice(models.Model):
    ...
    Each student can have at most 3 choices, each with a unique priority.
    """
    ...
    class Meta:
        unique_together = [
            ('student', 'priority'),   # one elective per priority per student
            ('student', 'elective'),   # no duplicate elective choices
        ]
        ordering = ['priority']
